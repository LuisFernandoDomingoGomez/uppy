    ...
    <div class="max-w-4xl">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Crear rol</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Crea un nuevo rol y asigna permisos</p>
            </div>
